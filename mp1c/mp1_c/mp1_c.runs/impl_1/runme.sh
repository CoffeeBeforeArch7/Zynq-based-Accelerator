...
HD_PWD='C:/Users/nabil/mp1_c/mp1_c.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log system_c_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source system_c_wrapper.tcl -notrace
