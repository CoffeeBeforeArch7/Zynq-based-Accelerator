...
HD_PWD='C:/Users/nabil/mp1_c/mp1_c.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_c_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_c_wrapper.tcl
