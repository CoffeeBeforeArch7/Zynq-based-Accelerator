...
HD_PWD='C:/Users/nabil/mp1_b/mp1_b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log switch_led_modes.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source switch_led_modes.tcl -notrace
