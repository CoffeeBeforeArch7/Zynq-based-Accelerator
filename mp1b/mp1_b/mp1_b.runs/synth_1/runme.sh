...
HD_PWD='C:/Users/nabil/mp1_b/mp1_b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log switch_led_modes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source switch_led_modes.tcl
