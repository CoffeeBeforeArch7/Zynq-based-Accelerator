...
REM
REM Generated by Vivado on Mon Sep 08 18:52:15 -0500 2025
...
echo "xvlog --incr --relax -prj switch_led_modes_tb_vlog.prj"
call xvlog  --incr --relax -prj switch_led_modes_tb_vlog.prj -log xvlog.log
