...
REM
REM Generated by Vivado on Tue Sep 02 18:50:09 -0500 2025
...
echo "xvlog --incr --relax -prj mp1_parta_tb_vlog.prj"
call xvlog  --incr --relax -prj mp1_parta_tb_vlog.prj -log xvlog.log
